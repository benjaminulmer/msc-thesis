...
For example, with aircraft collision detection and avoidance, the altitude of aircrafts is just as important as their geographic coordinates.
In these types of applications, instead of managing altitude separately, the DGGS should be responsible for hierarchically partitioning altitude in addition to the surface of the Earth.
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.5\textwidth]{embedded.pdf}
