...
\begin{figure}[ht!]
	...
	\caption[Comparison of embedded and Earth-centric approaches for a 3D DGGS]{
		...
		This is not the case in the embedded grid, with arrows intersecting cells boundaries at different angles depending on where the cell is located in the grid.
