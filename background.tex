...
\begin{figure}[h]
	...
	\caption[A Latitude Longitude Grid]{
		\textbf{Placeholder} A latitude-longitude grid (LLG) with 24 longitudinal division and 12 latitudinal divisions.
...
\begin{figure}[h]
	...
	\caption[A Icosahedron Based Grid]{
		\textbf{Placeholder} A simple triangular grid based on a regular icosahedron.
		Projection goes between polyhedron domain and spherical domain
	}
	\label{fig:poly-grid}
\end{figure}
