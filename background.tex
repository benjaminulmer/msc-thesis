...
To be useful in the context of a DGGS, refinement should also maintain the relative shape of cells between different resolutions.
...
This degeneration somethine compactness, area, connectivity something something.
