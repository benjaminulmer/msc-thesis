...
One notable example of a volumetric Digital Earth is the use of atmosphere and weather observations for global numerical weather predictions and reanalysis [ncep/ncar and ECMWF].
...
Instead, third parties such as Windy[] and Ventusky[] have produced visualizations of these datasets in order to make them more readily available to the public.
