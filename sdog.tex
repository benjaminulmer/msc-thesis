...
\begin{table}[htp!]
	\centering
	\caption[Convergence values of volume and compactness measures for the different grids]{
		Convergence value of each measure for the four discussed grids
	}
	\begin{tabular}{@{} c c c c c c @{}}
		\toprule
		& SDOG & $\alpha_{\phi}^{SG} \approx 0.54$ & $\alpha_{\phi}^{SG} = 0.57$ & $\beta = 1$ & $\beta = 0.5$ \\ \midrule
		Volume Ratio     & 8.88   & 8.17   & 8.15   & 2.63      & 4.37   \\
		CV of Volume     & 0.412  & 0.399  & 0.409  & 6.44E-19  & 0.211  \\
		Mean Sphericity  & 0.799  & 0.797  & 0.795  & 0.767     & 0.787  \\
		SD of Sphericity & 0.00639& 0.00629& 0.00727& 0.0271    & 0.0141 \\ \bottomrule
	\end{tabular}
	\label{tab:results}
\end{table}
...
\begin{table}[htp!]
	\centering
	\caption[Convergence values of sphericity measures for the different grids]{
		Convergence value of max and min sphericity for the four discussed grids
	}
	\begin{tabular}{@{} c c c c c c @{}}
		\toprule
		& SDOG & $\alpha_{\phi}^{SG} \approx 0.54$ & $\alpha_{\phi}^{SG} = 0.57$ & $\beta = 1$ & $\beta = 0.5$ \\ \midrule
		Max sphericity & 0.806  & 0.806  & 0.806  & 0.806 & 0.806  \\
		Min sphericity & 0.754  & 0.763  & 0.766  & 0.672 & 0.728  \\
		Difference     & 0.0520 & 0.0428 & 0.0404 & 0.134 & 0.0780 \\ \bottomrule
	\end{tabular}
