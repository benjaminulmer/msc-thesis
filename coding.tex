...
We introduce modifications of conventional direct indexing that work for conventional SDOG.%TODO


For a uniform grid, the coordinate indices of the cell that contain a point are obtained trivially in constant time.%TODO expand here
