...
Figure~X illustrates the pipeline for our proposed split of these operations.
...
Describe how to calculate new values of $s'$, $j'$, and $k'$ from values given for the input layer.
...
\paragraph{Children}
The children layers depend on if the layer in question is central or normal.
