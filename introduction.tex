...
\begin{enumerate}
	...
	Furthermore, clearly defined parameters allow for a target aspect ratio for cells and---like the SDOG modifications---a balanced tradeoff between volume preservation and cell compactness.
...
Chapter~\ref{chap:implementation} contains implementation details.
